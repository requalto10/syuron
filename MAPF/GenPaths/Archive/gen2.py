...
# プロットするエージェント数を制限（例: 10人）して描画時間を短縮
plot_agents = random.sample(list(agent_time_positions.keys()), min(10, a))
...
ax.set_ylabel('Y')
ax.set_zlabel('Time')
ax.set_title('Agent Paths in 3D Space (Sample of Agents)')
ax.legend()
plt.show()
